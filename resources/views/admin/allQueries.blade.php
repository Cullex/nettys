                                        ...
                                        @foreach($queries as $querie)
                                            <tr>
                                                <td style="min-width: 200px;">
                                                    ...
                                                    <h2><a href="">{{ $querie->name }} <span>{{$querie->idNo}}</span></a></h2>
                                                </td>
                                                <td>
                                                    <h5 class="time-title p-0">Contact No</h5>
                                                    <p>{{ $querie->contactNumber }}</p>
                                                </td>
                                                <td>
                                                ...
                                                <td class="text-right">
                                                    <a href="{{ 'viewApplication/'.$querie->id }}" class="btn btn-outline-primary take-btn">View Application</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
