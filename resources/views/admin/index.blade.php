        ...
        <div class="content">
                ...
                <div class="col-12 col-md-6 col-lg-12 col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title d-inline-block">Received Applications</h4> <a href="appointments.html" class="btn btn-primary float-right">View all</a>
                        </div>
                                        ...
                                        @foreach($applications as $application)
                                            <tr>
                                                <td style="min-width: 200px;">
                                                    ...
                                                    <h2><a href="">{{ $application->name }} <span>{{$application->idNo}}</span></a></h2>
                                                </td>
                                                <td>
                                                    <h5 class="time-title p-0">Contact No</h5>
                                                ...
                                                <td class="text-right">
                                                    <a href="appointments.html" class="btn btn-outline-primary take-btn">View Application</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title d-inline-block">Received Queries</h4> <a href="patients.html" class="btn btn-primary float-right">View all</a>
                        </div>
                        <div class="card-block">
                            <div class="table-responsive">
                                <table class="table mb-0 new-patient-table">
                                    ...
                                    <tr>
                                        <td>
                                            <img width="28" height="28" class="rounded-circle" src="{{asset('admin_dashboard/assets/img/user.jpg')}}" alt="">
                                            <h2>John Doe</h2>
                                        </td>
                                        <td>Johndoe21@gmail.com</td>
                                        <td>+1-202-555-0125</td>
                                        <td><button class="btn btn-primary btn-primary-one float-right">View Query</button></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <img width="28" height="28" class="rounded-circle" src="{{asset('admin_dashboard/assets/img/user.jpg')}}" alt="">
                                        ...
                                        <td>202-555-0127</td>
                                        <td><button class="btn btn-primary btn-primary-two float-right">View Query</button></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <img width="28" height="28" class="rounded-circle" src="{{asset('admin_dashboard/assets/img/user.jpg')}}" alt="">
                                        ...
                                        <td><button class="btn btn-primary btn-primary-three float-right">View Query</button></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <img width="28" height="28" class="rounded-circle" src="{{asset('admin_dashboard/assets/img/user.jpg')}}" alt="">
                                        ...
                                        <td><button class="btn btn-primary btn-primary-four float-right">View Query</button></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
