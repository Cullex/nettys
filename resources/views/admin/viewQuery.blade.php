                ...
                <div class="col-lg-8 offset-lg-2">
                    <form action="/edit" method="POST" enctype = "multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input class="form-control" type="text" name="title" disabled value="{{ $query->name }}" required>
                        </div>
                        <div class="form-group">
                            <label>Contact Number</label>
                            <input class="form-control" type="text" name="title" disabled value="{{ $query->contactNumber }}" required>
                        </div>
                        <div class="form-group">
                            <label>Email</label>
                            - <input class="form-control" type="text" name="title" disabled value="{{ $query->email }}" required>
                        </div>
                        <div class="form-group">
                            <label>Subject</label>
                            <input class="form-control" type="text" name="title" disabled value="{{ $query->description }}" required>
                        </div>
