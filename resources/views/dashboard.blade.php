        ...
        <div class="content">
                ...
                <div class="col-12 col-md-6 col-lg-12 col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title d-inline-block">Received Applications</h4> <a href="/allApplications" class="btn btn-primary float-right">View all</a>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a href="{{ 'viewApplication/'.$application->id }}" class="btn btn-outline-primary take-btn">View Application</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                        @endif
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title d-inline-block">Received Queries</h4> <a href="/allQueries" class="btn btn-primary float-right">View all</a>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0 new-patient-table">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ 'viewQuery/'.$query->id }}" class="btn btn-outline-primary take-btn">View Query</a></td>
